					...
					{variants.map((variant) => {
						...
						return (
							<LinkWithChannel
								...
								className={clsx(
									isCurrentVariant
										? "border-[#FA9874] bg-[#FFECE5] text-[#101928] hover:bg-[#FFECE5]"
										: "border-neutral-200 bg-white text-neutral-900 hover:border-[#FA9874]",
									"relative flex min-w-[5ch] items-center justify-center overflow-hidden text-ellipsis whitespace-nowrap rounded-lg border p-3 text-center text-sm font-semibold outline-none aria-disabled:cursor-not-allowed aria-disabled:bg-neutral-100 aria-disabled:text-neutral-800 aria-disabled:opacity-50",
